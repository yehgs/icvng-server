...
const fomoSettingsSchema = new mongoose.Schema(
  {
    ...
    // Animation
    animationType:    { type: String, enum: ['fade', 'slide', 'bounce'], default: 'fade' },
    position:         { type: String, enum: ['bottom-left', 'bottom-right', 'top-left', 'top-right'], default: 'bottom-left' },
